import { Plus, Soup, Utensils, UtensilsCrossed } from 'lucide-react'
import React from 'react'
import { formatPrice } from '../../utlis/formatPrice'

export default function MenuGrid({ displayItems }) {
    return (
    <div className="grid grid-cols-2 gap-3 px-4">
        {displayItems.map((item) => (
            <div key={item.id} className="card bg-white shadow-sm rounded-2xl overflow-hidden border border-gray-100 flex flex-col">
                {/* Image Wrapper */}
